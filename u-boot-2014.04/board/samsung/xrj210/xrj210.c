...
{	
	...
	struct xrj210_clock *const clock = (struct xrj210_clock *)samsung_get_base_clock();
...
void ddr_init(void)
{
	struct xrj210_dmc0 *const dmc0 = (struct xrj210_dmc0 *)samsung_get_base_dmc0();
	struct xrj210_dmc1 *const dmc1 = (struct xrj210_dmc1 *)samsung_get_base_dmc1();
